...
function HomePage() {
    return (
        ...
        >
            {/* Plain background shade from the color palette */}
            <div className="absolute inset-0 z-0 bg-[#F472B6]"></div>

            <div className="w-full relative z-10">
                <div className="bg-[#F9F5F5] dark:bg-[#F9F5F5] shadow-2xl relative overflow-hidden animate-in slide-in-from-bottom-8 fade-in duration-1000 fill-mode-both flex flex-col lg:flex-row">
